...
//   };
  ...
  export default function Index() {
    ...
    const FieldWithIcon = ({ table, selectedField }: { table: string, selectedField: string }) => {
      ...
      return (
        <span className="flex items-center h-5 rounded-none color-text-tertiary">
          ...
          <FieldSelected
            selectedTable={Tables.find(t => t.name === table) || Tables[0]}
    ...
    const currentTable = Tables.find(t => t.name === queryState.selectedTable) || Tables[0];
                ...
                <div className="bg-white w-full">
                  <div className="flex flex-col items-start gap-3 bg-white p-4 w-full rounded-t-xl">
                    <div className="flex flex-wrap gap-3 bg-white w-full">
                      ...
                      {queryState.selectedFields.map((field, index) => (
                          ...
                          <div className="flex items-center gap-1">
                            <span className="bg-fields text-sm flex items-center gap-1">
                              <span className="flex justify-center">
                                <FieldWithIcon selectedField={field} table={currentTable.name}/>
                              </span>
                            </span>
                          </div>
                        </div>
